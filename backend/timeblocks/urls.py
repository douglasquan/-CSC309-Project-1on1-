...
from .views import CreateTimeblockView, TimeblockListView
urlpatterns = [
    # Event timeblocks
   ...
   path('events/<int:event_id>/availability/timeblocks/', CreateTimeblockView.as_view(), name='create_availability_timeblock'),
   path('events/<int:event_id>/availability/<int:user_id>/timeblocks/', TimeblockListView.as_view(), name='list_availability_timeblocks'),
