...
from timeblocks.models import AvailabilityTimeblock
...
class Availability(models.Model):
    ...
    timeblock_id = models.ForeignKey(AvailabilityTimeblock, on_delete=models.SET_NULL, null=True, blank=True)  # Assuming it's optional and not always immediately known
